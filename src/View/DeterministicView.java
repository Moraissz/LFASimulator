 ...
 * @author lucas
 */
public class DeterministicView extends javax.swing.JFrame {
    ...
    private void jBtnOpenFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOpenFileActionPerformed
        ...
        if (returnedValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(DeterministicView.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeterministicView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeterministicView().setVisible(true);
            }
        });
    }
